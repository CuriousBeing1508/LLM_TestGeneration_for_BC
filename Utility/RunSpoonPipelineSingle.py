...
# === Load CSV and process first instance ===
...
pull_number = github_url.split("/pull/")[-1]
...
try:
    ...
    # Fallback: fetch PR ref if commit not found
    if not commit_exists(client_repo_path, breaking_commit):
