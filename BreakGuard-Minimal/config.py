"""Path resolution for the BreakGuard-Minimal execution pipeline.
...
already-generated LLM test outputs for Minimal-context) and
...
LLM_OUTPUT_SUBDIR = "Exp3LLMOutput"
CONTEXT_BATCH_DIRNAME = "Exp3BatchResults"

PACKAGE_ROOT = Path(__file__).resolve().parent
CONFIG_DIR = PACKAGE_ROOT / "data" / "ConfigFiles"

# --model key -> (folder name under <data_root>/FilteredDataset/Exp3LLMOutput/,
