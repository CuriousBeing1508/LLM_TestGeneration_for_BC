...
the METHOD prompting context (the LLM was given the enclosing method(s) as context when generating each test).
...
sitting at `<data-root>/<ModelResults>/Exp6BatchResults/...` on the
