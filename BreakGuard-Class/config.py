"""Path resolution for the BreakGuard-Class execution pipeline.
...
already-generated LLM test outputs for Class-context) and
...
LLM_OUTPUT_SUBDIR = "Exp7LLMOutput"
CONTEXT_BATCH_DIRNAME = "Exp7BatchResults"

PACKAGE_ROOT = Path(__file__).resolve().parent
CONFIG_DIR = PACKAGE_ROOT / "data" / "ConfigFiles"

# --model key -> (folder name under <data_root>/FilteredDataset/Exp7LLMOutput/,
