...
_args, _paths = parse_common_args(
    "BREAKING stage: execute carried-forward tests against the BREAKING (post-upgrade) codebase - single-module projects"
)

CSV_PATH = _paths["csv_path"]
SUMMARY_PATH = _paths["summary_path"]
PRE_RESULTS_PATH = _paths["final_pre_output"]
BREAKING_OUTPUT = _paths["breaking_single_output"]
