...
# === PATHS ===
PROMPT_DIR = Path("/Volumes/Rachna-HD/GeneratedPromptsWithVersion")
OUTPUT_ROOT = Path("/Volumes/Rachna-HD/Generated_output") / "GPT4o"
...
if __name__ == "__main__":
    ...
    print("\All model responses saved under /Volumes/Rachna-HD/Generated_output/GPT4o/")
