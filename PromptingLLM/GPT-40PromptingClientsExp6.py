...
# === PATHS ===
PROMPT_DIR = Path("/Volumes/Rachna-HD/Dataset/GeneratedPromptsClientsExp6")
OUTPUT_ROOT = Path("/Volumes/Rachna-HD/GeneratedOutputClientsExp6") / "GPT4o"
...
if __name__ == "__main__":
    ...
    print("\All model responses saved under /Volumes/Rachna-HD/GeneratedOutputClientsExp6/GPT4o/")
