...
TEST_COMPILE_RESULTS_PATH = RESULT_DIR / "step2_test_compile_results_next1.json"
TEST_EXECUTION_RESULTS_PATH = RESULT_DIR / "step3_test_execution_results_next1.json"
