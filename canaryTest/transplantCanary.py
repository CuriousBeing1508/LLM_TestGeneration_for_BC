...
from common import parse_package_summary, classify_compilation_error, LOG_CANARY_V2_DIR
# Extension of v3
...
TRANSPLANT_OUTPUT = PRIMARY_DRIVE / "CanaryResults/transplant_results_final_execv7.json"
CSV_SUMMARY_OUTPUT = PRIMARY_DRIVE / "CanaryResults/transplant_results_final_exec_summaryv7.csv"
ABC_ROOT = PRIMARY_DRIVE / "GeneratedOutputClientsExp3/GPT4o"
...
def run_canary_in_container(image_tag, custom_id, test_root, java_code):
    log_path = LOG_CANARY_V2_DIR / f"{custom_id}_canary_exec.log"
...
def main():
    ...
    with open(CSV_PATH) as f:
        ...
        for row in reader:
            ...
            testing_framework = row.get("test_framework", "").strip().lower()
