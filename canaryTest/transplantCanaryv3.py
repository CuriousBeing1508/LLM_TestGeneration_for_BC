...
# This is the latest best script.
# === CONFIG ===
...
# Update this path to your actual directory if needed.
...
# Minimal helper: return True iff ABC/<custom_id> contains at least one file (recursively)
...
def main():
    ...
    with open(CSV_PATH) as f:
        ...
        for row in reader:
            ...
            # NEW: early skip if ABC/<custom_id> has no files
