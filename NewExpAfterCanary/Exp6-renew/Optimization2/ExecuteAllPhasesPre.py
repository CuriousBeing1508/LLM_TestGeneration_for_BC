...
# MASTER_LOG = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/pre/master_execution_log.txt")
...
MASTER_LOG = Path("/Volumes/Rachna-HD/Qwen480Results/Exp6BatchResults/pre/master_execution_log.txt")
