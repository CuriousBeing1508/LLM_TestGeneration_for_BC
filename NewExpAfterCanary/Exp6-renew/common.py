...
LOG_DIR = Path("/Volumes/Rachna-HD/Exp6BatchResults/logs")
...
LOG_CANARY_DIR = Path("/Volumes/Rachna-HD/Exp6BatchResults/CanaryResults/logs")
LOG_CANARY_DIR.mkdir(parents=True, exist_ok=True)



# For Batch execution pre
LOG_DIR_BATCH = Path("/Volumes/Rachna-HD/Exp6BatchResults/pre/logs")
...
LOG_CANARY_DIR_BATCH = Path("/Volumes/Rachna-HD/Exp6BatchResults/CanaryResults/logs")
LOG_CANARY_DIR.mkdir(parents=True, exist_ok=True)


# For Batch execution breaking
LOG_DIR_BATCH_BRE = Path("/Volumes/Rachna-HD/Exp6BatchResults/bre/logs")
LOG_DIR_BATCH_BRE.mkdir(parents=True, exist_ok=True)

LOG_EXEC_DIR_BATCH = Path("/Volumes/Rachna-HD/Exp6BatchResults/logs/executionPhase")
...
LOG_CANARY_DIR_BATCH_BRE = Path("/Volumes/Rachna-HD/Exp6BatchResults/CanaryResults/logs")
LOG_CANARY_DIR.mkdir(parents=True, exist_ok=True)
