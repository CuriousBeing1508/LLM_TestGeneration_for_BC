...
if __name__ == "__main__":
    ...
    root_folder = "/Volumes/Rachna-HD/GeneratedPromptsClientsExp7"  # Your main folder containing subfolders with txt files
    output_csv = "/Volumes/Rachna-HD/Exp7BatchResults/test_files_filter.csv"  # Output CSV file name
