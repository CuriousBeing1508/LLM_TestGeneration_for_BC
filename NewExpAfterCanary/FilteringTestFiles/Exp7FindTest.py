...
if __name__ == "__main__":
    ...
    root_folder = PRIMARY_DRIVE / "GeneratedPromptsClientsExp7"  # Your main folder containing subfolders with txt files
    output_csv = PRIMARY_DRIVE / "Exp7BatchResults/test_files_filter.csv"  # Output CSV file name
