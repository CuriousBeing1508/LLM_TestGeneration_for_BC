...
def main():
    ...
    json_path = '/Volumes/Rachna-HD/GPTResults/Exp7BatchResults/pre/transplant_results_final_pre.json'
    csv_path = '/Volumes/Rachna-HD/GPTResults/Exp7BatchResults/test_files_filter.csv'
    output_path = '/Volumes/Rachna-HD/GPTResults/Exp7BatchResults/pre/transplant_results_pre_filteredExp7.json'
