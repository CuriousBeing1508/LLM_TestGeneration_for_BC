...
LOG_DIR = Path("/Volumes/RachnaPSSD/Exp3BatchResults/logs")
LOG_DIR.mkdir(parents=True, exist_ok=True)



LOG_CANARY_DIR = Path("/Volumes/RachnaPSSD/Exp3BatchResults/CanaryResults/logs")
LOG_CANARY_DIR.mkdir(parents=True, exist_ok=True)



# For Batch execution pre
LOG_DIR_BATCH = Path("/Volumes/RachnaPSSD/Exp3BatchResults/pre/logs")
LOG_DIR_BATCH.mkdir(parents=True, exist_ok=True)



LOG_CANARY_DIR_BATCH = Path("/Volumes/RachnaPSSD/Exp3BatchResults/CanaryResults/logs")
LOG_CANARY_DIR.mkdir(parents=True, exist_ok=True)


# For Batch execution breaking
LOG_DIR_BATCH_BRE = Path("/Volumes/RachnaPSSD/Exp3BatchResults/bre/logs")
LOG_DIR_BATCH_BRE.mkdir(parents=True, exist_ok=True)

LOG_EXEC_DIR_BATCH = Path("/Volumes/RachnaPSSD/Exp3BatchResults/logs/executionPhase")
LOG_EXEC_DIR_BATCH.mkdir(parents=True, exist_ok=True)


LOG_CANARY_DIR_BATCH_BRE = Path("/Volumes/RachnaPSSD/Exp3BatchResults/CanaryResults/logs")
LOG_CANARY_DIR.mkdir(parents=True, exist_ok=True)
