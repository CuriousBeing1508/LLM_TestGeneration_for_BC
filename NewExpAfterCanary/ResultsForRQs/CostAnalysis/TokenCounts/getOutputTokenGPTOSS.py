#!/usr/bin/env python3
"""
Count tokens in generated prompt .txt files using the GPT-OSS tokenizer, across
...
# (the model, e.g. GPT_OSS_120b, is already baked into the exp_folder path below)
EXPERIMENTS = {
    "Exp3LLMOutput/GPT_OSS_120b": "minimal",
    "Exp6LLMOutput/GPT_OSS_120b": "method",
    "Exp7LLMOutput/GPT_OSS_120b": "class",
}
...
def main():
    ...
    for exp_folder, context_variant in EXPERIMENTS.items():
        ...
        # The model name (e.g. GPT_OSS_120b) is the last component of exp_folder.
        model = exp_root.name
