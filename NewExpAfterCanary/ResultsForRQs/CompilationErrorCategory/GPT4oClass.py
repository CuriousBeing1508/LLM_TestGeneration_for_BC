...
class CompilationErrorCategorizer:
    ...
    def __init__(self):
        ...
        self.error_patterns = {
            # SYMBOL NOT FOUND ERRORS - Check symbol type from context
            'symbol_class': {
                'pattern': r'cannot find symbol\s+symbol:\s+class\s+(\w+)',
                'priority': 12,
                'requires_context': True,
                'main_category': 'Symbol Not Found'
            },
            'symbol_method': {
            ...
            # CANNOT ACCESS - package visibility errors
            'cannot_access_class': {
                'pattern': r'cannot access (\w+)',
                'priority': 10,
                'requires_context': False,
                'main_category': 'Access Violation'
            },
            
            # NOT PUBLIC - package-private access
            ...
            'method_does_not_override': {
                ...
                'priority': 13,
                'requires_context': False,
                'main_category': 'Override/Implementation'
            },
            ...
            'constructor_signature_mismatch': {
                ...
                'priority': 11,
                'requires_context': False,
                'main_category': 'Signature Mismatch'
            },
            ...
            'ambiguous_reference': {
                ...
                'priority': 9,
                'requires_context': False,
                'main_category': 'Ambiguous Reference'
            },
            ...
            'cannot_inherit_from_final': {
                ...
                'priority': 10,
                'requires_context': False,
                'main_category': 'Inheritance Error'
            },
            ...
            'cannot_assign_final': {
                ...
                'priority': 9,
                'requires_context': False,
                'main_category': 'Final Variable Error'
            },
            ...
            'enclosing_instance_required': {
                ...
                'priority': 9,
                'requires_context': False,
                'main_category': 'Inner Class Error'
            },
            ...
            'static_context_error': {
                ...
                'priority': 7,
                'requires_context': False,
                'main_category': 'Static Context Error'
            },
            
            # TEST FRAMEWORK ERRORS
            'missing_test_annotation': {
                'pattern': r'cannot find symbol\s+symbol:\s+class\s+Test',
                'priority': 14,
                'requires_context': False,
                'main_category': 'Test Framework'
            },
            'missing_assertion_method': {
                'pattern': r'cannot find symbol\s+symbol:\s+method\s+(assert\w+)',
                'priority': 14,
                'requires_context': False,
                'main_category': 'Test Framework'
            },
            ...
            'mockito_related': {
                ...
                'priority': 15,
                'requires_context': True,
                'main_category': 'Mocking/Dependency'
            },
            ...
            if match:
                ...
                if config['requires_context']:
                    ...
                    if category == 'mockito_related':
                        ...
                        # Already matched, just return it
...
def print_summary(summary: Dict):
    ...
    for item in dist.get('main_categories_files_affected', []):
        print(f"{item['main_category']:30s}: {item['files_affected']:4d} files ({item['percentage_of_files']:5.1f}%)")
...
if __name__ == "__main__":
    ...
    OUTPUT_CSV = "/Volumes/Rachna-HD/GPTResults/CompilErrorAnalysisResults/compilation_errors_GPT4o_Class.csv"
    OUTPUT_JSON = "/Volumes/Rachna-HD/GPTResults/CompilErrorAnalysisResults/compilation_errors_GPT4o_Class.json"
