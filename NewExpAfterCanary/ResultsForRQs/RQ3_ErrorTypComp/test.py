        ...
        for pattern in self.exception_patterns:
            ...
            for match in matches:
                ...
                if error_name and ('Exception' in error_name or 'Error' in error_name):
                    # Filter out common non-error words
...
if __name__ == "__main__":
    ...
    OUTPUT_CSV = "/Volumes/Rachna-HD/GPTResults/Exp3BatchResults/bre/RQ4/BREErrorTypes/error_comparison.csv"
    OUTPUT_JSON = "/Volumes/Rachna-HD/GPTResults/Exp3BatchResults/bre/RQ4/BREErrorTypes/error_comparison.json"
