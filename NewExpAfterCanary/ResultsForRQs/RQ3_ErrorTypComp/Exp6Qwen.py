...
if __name__ == "__main__":
    # Configuration
    LLM_RESULTS_JSON = PRIMARY_DRIVE / "Qwen480Results/Exp6BatchResults/bre/transplant_results_breaking_single_module.json"
    BUMP_ERROR_CSV = PRIMARY_DRIVE / "RQResults/RQ4_resultsBUMP.csv"
    LLM_LOGS_DIR = PRIMARY_DRIVE / "Qwen480Results/Exp6BatchResults/bre/logs"
    OUTPUT_CSV = PRIMARY_DRIVE / "Qwen480Results/Exp6BatchResults/bre/RQ4/BREErrorTypes/error_comparison.csv"
    OUTPUT_JSON = PRIMARY_DRIVE / "Qwen480Results/Exp6BatchResults/bre/RQ4/BREErrorTypes/error_comparison.json"
