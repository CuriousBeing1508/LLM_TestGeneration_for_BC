...
# === CONFIG ===
BREAKING_RESULTS_PATH = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/bre/transplant_results_breaking_single_module.json")
OUTPUT_STATS_PATH = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/bre/exp7breRQ2Stats.json")
