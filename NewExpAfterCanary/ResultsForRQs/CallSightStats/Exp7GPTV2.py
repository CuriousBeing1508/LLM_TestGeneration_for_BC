...
# === CONFIG ===
PRE_RESULTS = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/pre/transplant_results_final_pre.json")
BREAKING_RESULTS = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/bre/transplant_results_breaking_single_module.json")

PROMPT_ROOT = Path("/Volumes/Rachna-HD/FilteredDataset/Exp7Prompts")
LOG_DIR = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/bre/logs")
OUTPUT_DIR = Path("/Volumes/Rachna-HD/GPTResults/Exp7BatchResultsOp2/bre/RQ3")
