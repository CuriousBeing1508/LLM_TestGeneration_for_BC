...
BREAKING_OUTPUT = Path("/Volumes/Rachna-HD/Exp7BatchResults/breaking/transplant_results_final_breakingV5.json")
ABC_ROOT = Path("/Volumes/Rachna-HD/GeneratedOutputClientsExp7Batch/GPT4o")
MODEL_NAME = ABC_ROOT.name  # e.g., "GPT4o"

SCRATCH_BASE = Path("/Volumes/Rachna-HD/Exp7BatchResults/breaking/scratch")
REPORTS_BASE = Path("/Volumes/Rachna-HD/Exp7BatchResults/breaking/reports")
