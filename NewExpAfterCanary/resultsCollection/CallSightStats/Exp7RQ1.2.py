...
PROMPT_ROOT = Path("/Volumes/Rachna-HD/FilteredDataset/Exp7Prompts")  # Changed from LLMOutput
ABC_ROOT = Path("/Volumes/Rachna-HD/FilteredDataset/Exp7LLMOutput/GPT4o")  # Keep for reference if needed
