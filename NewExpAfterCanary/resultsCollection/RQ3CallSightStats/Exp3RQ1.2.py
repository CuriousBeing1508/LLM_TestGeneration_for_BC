...
# === CONFIG ===
PRE_RESULTS = Path("/Volumes/Rachna-HD/GPTResults/Exp3BatchResults/pre/transplant_results_pre_filteredExp3.json")
BREAKING_RESULTS = Path("/Volumes/Rachna-HD/GPTResults/Exp3BatchResults/breaking/transplant_results_final_breaking_hybrid.json")

# UPDATED: Read from LLMPrompt instead of LLMOutput
PROMPT_ROOT = Path("/Volumes/Rachna-HD/FilteredDataset/Exp3Prompts")  # Changed from LLMOutput
ABC_ROOT = Path("/Volumes/Rachna-HD/FilteredDataset/Exp3LLMOutput/GPT4o")  # Keep for reference if needed

LOG_DIR = Path("/Volumes/Rachna-HD/GPTResults/Exp3BatchResults/bre/logs")
OUTPUT_DIR = Path("/Volumes/Rachna-HD/GPTResults/Exp3BatchResults/breaking")
